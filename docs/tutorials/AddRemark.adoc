...
Create a `RemarkCommandParser` class in the `seedu.tracker.logic.parser` package.
...
Create a new `Remark` in `seedu.tracker.model.person`. Since a `Remark` is a field that is similar to `Address`, we can reuse a significant bit of code.
...
to link:https://github.com/nus-cs2103-AY1920S1/addressbook-level3/commit/2758455583f0101ed918a318fc75679270843a0d#diff-0c6b6abcfac8c205e075294f25e851fe[`seedu.tracker.ui.PersonCard`].
